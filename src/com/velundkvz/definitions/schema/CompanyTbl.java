...
public final class CompanyTbl
{
   ...
   public static final String UPDATE_COMPANY_EMAIL_BY_ID_SQL = "update " + COMPANY_TBL + " set " + COL_E_MAIL + " = ?"   + " where " + COL_ID + " = " + "?" ;
   ...
   public static final String SELECT_COMPANY_BY_EMAIL_AND_PSWD_SQL = "select * from " + COMPANY_TBL + " where " + COL_E_MAIL + " = ?" + " and " + COL_PASSWORD + " = ?";
   ...
   public static final String IS_COMPANY_EXISTS_BY_EMAIL_SQL = "select exists (select " + COL_E_MAIL + " from " + COMPANY_TBL + " where " + COL_E_MAIL + " = ?)";
